...
add_action('admin_enqueue_scripts', 'load_map_admin_script');
function load_map_admin_script($hook)
{

    if ($hook != 'settings_page_wp-miniaudioplayer/miniAudioPlayer-admin') {
        return;
    }
    wp_enqueue_style('map_admin_css', plugins_url('inc/map_admin.css', __FILE__), null, MINIAUDIOPLAYER_VERSION);
...
function miniAudioPlayer_options_page(){ // Output the options page
    ...
    <div id="donate">
        <div id="donateContent">
            ...
            <p><a href="http://pupunzi.open-lab.com/make-a-donation/" target="_blank" onclick="donate()">
    ...
    <div class="highlight fade" style="padding: 10px; margin: 0">
        ...
        <form action="http://pupunzi.us6.list-manage2.com/subscribe/post?u=4346dc9633&amp;id=91a005172f" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
            <label for="mce-EMAIL" style="font-weight: bold"><?php _e('Subscribe to my mailing list <br>to stay in touch', 'wp-miniaudioplayer'); ?>.</label>
